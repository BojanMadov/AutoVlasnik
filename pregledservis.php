					...
					<div class="row">
						<div class="12u">
							<section id="content">
								...
								<p class="subtitle">Spisak svih servisa koje ste vrsili na vasem vozilu</p>
								<p><img src="images/servis2.jpg" alt="" width="700" height="160"></p>
								
                                                                <?php include 'readservis.php'; 
		...
		<div class="row">
			...
			<div class="6u">
				<section>
					...
					<p>Listing servisa vrsenih na vozilima.</p>
